...
class Admin::BackupsController < Admin::AdminController
  before_action :ensure_backups_enabled, :check_developer
  ...
  def email
    if is_developer?(current_user.email)
      ...
      render_error("Email Not Permitted Unless Developer")
    end
  end
  ...
  def destroy
    if is_developer?(current_user.email)
      ...
      render_error("Destroy Not Permitted Unless Developer")
    end
  end
  ...
  def rollback
    if is_developer?(current_user.email)
      ...
      render_error("Rollback Not Permitted Unless Developer")
    end
  rescue BackupRestore::OperationRunningError
    render_error("backup.operation_already_running")
  else
